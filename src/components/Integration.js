  ...
  return (
    <div className="tab-content">
      <div className="tab-header">
        <h1>Integration</h1>
        <p>Connect and manage third-party services, APIs, and tools to extend your platform’s functionality.</p>
      </div>
      <div className="empty-state">
        ...
        <h3>Coming Soon</h3>
        <p>Integration options with popular services and custom APIs will be available in the next update. Easily sync data, automate workflows, and enhance your experience.</p>
      </div>
    </div>
  );
}
